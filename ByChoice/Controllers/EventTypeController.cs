...
namespace ByChoice.Controllers
{
    public class EventTypeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EventTypeId,EventName,IsSelected")] EventType eventType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EventTypeId,EventName,IsSelected")] EventType eventType)
        {
            if (ModelState.IsValid)
            {
